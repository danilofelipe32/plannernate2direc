...
import { Bold, Italic, List, X, Check, Palette, Wand2, Loader2, Send } from 'lucide-react';
  ...
  return (
    <div className="fixed inset-0 bg-slate-900/50 backdrop-blur-sm z-[60] flex items-center justify-center p-4">
      <div className="bg-white dark:bg-slate-800 rounded-2xl shadow-xl w-full max-w-2xl flex flex-col">
        ...
        <div className="p-4 border-b border-slate-100 dark:border-slate-700 flex gap-2 items-center flex-wrap">
          <button 
            type="button"
            onMouseDown={(e) => e.preventDefault()}
            onClick={() => applyFormat('bold')} 
            className="p-2 hover:bg-slate-100 dark:hover:bg-slate-700 rounded text-slate-700 dark:text-slate-300"
            title="Negrito"
          >
            <Bold size={18} />
          </button>
